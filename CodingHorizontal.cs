...
{
    class CodingHorizontal
    {
        public static void EndWay(object[][] qrCode, string words, int y1, int y2, int x1, int x2, int x3)
        {
